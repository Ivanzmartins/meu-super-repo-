...
const orderModifier = (order) => {
  ...
  order.payment = 50;
  const pizzass = Object.keys(order.order.pizza).join(', ');
  console.log(`Olá ${order.name}, o total do seu pedido de ${pizzass} e ${order.order.drinks.coke.type} é R$${order.payment},00.`)
