...
firstLi.addEventListener('click', changeClass); // adiciona um "ouvidor" de eventos aos li's
...
function mouseMudaCor(){
  if(myWebpage.style.color === 'white'){
    myWebpage.style.color = 'blue';
  } else 
  myWebpage.style.color = 'white'; 
}
myWebpage.addEventListener('mouseover', mouseMudaCor)
